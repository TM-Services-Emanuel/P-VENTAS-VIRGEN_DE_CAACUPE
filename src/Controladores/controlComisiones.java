...
public class controlComisiones {
    ...
    public static void listVentas(JTable tabla, String cod) {
        ...
        for (int i = 1; i < lista.size(); i++) {
            ...
            tb.addRow(fila);
            dlgComisionEmpleado.txtComision.setText(String.valueOf(Redondeo.redondearD(Double.parseDouble(fila[4].toString()))));
        }
    }
    ...
    public static void getCalculos() {
        ...
        dlgComisionEmpleado.txtTotalComisiones.setText(String.valueOf(Redondeo.redondearD(sumCom)));
    }
