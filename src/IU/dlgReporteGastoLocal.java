...
public class dlgReporteGastoLocal extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        rbGS = new javax.swing.JRadioButton();
        rbGR = new javax.swing.JRadioButton();
        rbGA = new javax.swing.JRadioButton();
        ...
        rbGFA.setText("Gastos del día (fecha actual):");
        ...
        rbGFF.setText("Gastos  entre fechas:");
        ...
        GrupoOpciones.add(rbGS);
        rbGS.setSelected(true);
        rbGS.setText("Gastos en Salón de Venta");
        rbGS.setOpaque(false);
        rbGS.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rbGSActionPerformed(evt);
            }
        });

        GrupoOpciones.add(rbGR);
        rbGR.setText("Gastos en Repartos");
        rbGR.setOpaque(false);

        GrupoOpciones.add(rbGA);
        rbGA.setText("Gastos Administrativos");
        rbGA.setOpaque(false);
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(rbGS, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(rbGA, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(rbGR, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(Blanco, javax.swing.GroupLayout.PREFERRED_SIZE, 323, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
    ...
    private void btnGenerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarActionPerformed
        ...
        } else if (rbGR.isSelected()) {
            try {
                if (rbGFA.isSelected()) {
                    LevantarReporte("\\Reports\\gastos\\gastosLocal.jasper", Date.valueOf(lbFechaActualR.getText().trim()), Date.valueOf(lbFechaActualR.getText().trim()), "R", "REPARTO");
                } else if (rbGFF.isSelected()) {
                    if (txtFDesde.getText().trim().isEmpty()) {
                        Mensajes.informacion("Fije la fecha desde");
                    } else if (txtFHasta.getText().trim().isEmpty()) {
                        ...
                        LevantarReporte("\\Reports\\gastos\\gastosLocal.jasper", Date.valueOf(txtFDesdeR.getText().trim()), Date.valueOf(txtFHastaR.getText().trim()), "R", "REPARTO");
                    }
        ...
        } else if (rbGA.isSelected()) {
            try {
                if (rbGFA.isSelected()) {
                    LevantarReporte("\\Reports\\gastos\\gastosLocal.jasper", Date.valueOf(lbFechaActualR.getText().trim()), Date.valueOf(lbFechaActualR.getText().trim()), "A", "ADMINISTRACIÓN");
                } else if (rbGFF.isSelected()) {
                    if (txtFDesde.getText().trim().isEmpty()) {
                        Mensajes.informacion("Fije la fecha desde");
                    } else if (txtFHasta.getText().trim().isEmpty()) {
                        ...
                        LevantarReporte("\\Reports\\gastos\\gastosLocal.jasper", Date.valueOf(txtFDesdeR.getText().trim()), Date.valueOf(txtFHastaR.getText().trim()), "A", "ADMINISTRACIÓN");
                    }
    ...
    private void rbGSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rbGSActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_rbGSActionPerformed
