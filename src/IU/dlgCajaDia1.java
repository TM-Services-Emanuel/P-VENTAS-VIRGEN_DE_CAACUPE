...
public final class dlgCajaDia1 extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        btnCerrar.setText("SALVAR VALORES");
    ...
    private void btnCerrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCerrarActionPerformed
        ...
        if (Integer.parseInt(txtEntregar.getText().trim().replace(",", "").replace(".", "")) < 0) {
            ...
            int resp = JOptionPane.showConfirmDialog(this, "¿Seguro que desea Modificiar y/o Cerrar esta Caja?", "ACTUALIZACIÓN/MODIFICACIÓN DE MOVIMIENTO DIARIO", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
            if (resp == JOptionPane.YES_OPTION) {
                try {
    ...
    private void btnGuardar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardar1ActionPerformed
        ...
        if (resp == JOptionPane.YES_OPTION) {
            if (Integer.parseInt(txtOpcion1.getText().trim()) <= 0) {
                ControlCaja.addBoca1_1();
            } else {
                ControlCaja.actBoca1_1();
            }
            totalVentasCont();
            totalVentasCred();
            totalCompraCont();
    ...
    private void btnGuardar2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardar2ActionPerformed
        ...
        if (resp == JOptionPane.YES_OPTION) {
            if (Integer.parseInt(txtOpcion2.getText().trim()) <= 0) {
                ControlCaja.addBoca2_1();
            } else {
                ControlCaja.actBoca2_1();
            }
            totalVentasCont();
            totalVentasCred();
            totalCompraCont();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dlgCajaDia1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
