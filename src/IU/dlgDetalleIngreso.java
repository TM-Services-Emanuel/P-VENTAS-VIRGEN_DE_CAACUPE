...
public class dlgDetalleIngreso extends javax.swing.JDialog {
    ...
    final void titulo(){
        if(Software.getSoftware().equals("null")){
            this.setTitle("Gestionar motivos de ingresos");
        }else{
            this.setTitle(Software.getSoftware()+" - Gestionar motivos de ingresos");
        }
    }
    ...
    private void initComponents() {
        ...
        txtDetalle.setFont(new java.awt.Font("Microsoft Sans Serif", 0, 11)); // NOI18N
        ...
        jLabel2.setText("Motivo Ingreso");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(txtDetalle, javax.swing.GroupLayout.PREFERRED_SIZE, 223, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        // TODO add your handling code here:
        if (validarCampos.estaVacio(txtDetalle) ) {
            try{
    ...
    private void tbDetalleMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbDetalleMouseClicked
        ...
        String cod = tbDetalle.getValueAt(fila, 0).toString();
        String nom = tbDetalle.getValueAt(fila, 1).toString();
