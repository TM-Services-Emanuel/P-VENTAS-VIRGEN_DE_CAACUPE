...
public class metodos {
    ...
    private final FileNameExtensionFilter filter = new FileNameExtensionFilter("Archivo de Imagen","jpg","png");
   ...
   public void Guardar_Dialogo(){
    ...
    public void Abrir_DialogoSeleccionImagen(JPanel p,JButton btn,JButton btn2, JLabel ruta, JLabel rutas){
       JFileChooser fileChooser = new JFileChooser();       
       fileChooser.setFileFilter(filter);
       int result = fileChooser.showOpenDialog(null);  
       if ( result == JFileChooser.APPROVE_OPTION ){
