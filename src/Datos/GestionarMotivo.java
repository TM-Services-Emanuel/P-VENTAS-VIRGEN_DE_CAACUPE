...
public class GestionarMotivo {
    ...
    public static String addMotivo(Motivo m) {
        ...
        sql.append(m.getUsuario()).append("')");
...
//                + m.getMotivo() + "','S')");
    ...
    public static String actMotivo(Motivo m) {
        ...
        sql.append(m.getMotivo()).append("', usu='");
        sql.append(m.getUsuario());
...
//                + m.getCodM() + "");
    ...
    public static String delMotivo(String cod, String usuario) {
        String msg;
        StringBuilder sql = new StringBuilder("UPDATE motivo SET mot_indicador= 'N', usu='");
        sql.append(usuario);
        sql.append("' WHERE mot_codigo =");
